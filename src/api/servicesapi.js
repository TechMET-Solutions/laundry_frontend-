...
const API = axios.create({
    baseURL: "http://localhost:5000/api/service/service_types",
});
export const getAllServiceTypes = () => API.get("/list");
...
const API2 = axios.create({
    baseURL: "http://localhost:5000/api/service/service_categories",
});
...
const API3 = axios.create({
    baseURL: "http://localhost:5000/api/service/service_addon",
});
