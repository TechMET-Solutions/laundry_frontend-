        ...
        <div className="min-h-screen bg-slate-100 p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-3">
              ...
              <button className="bg-indigo-800 text-white px-4 py-2 rounded-full flex items-center gap-2" onClick={()=>setaddTimeModal(true)}>
                ...
                {data.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center align-middle">
                        ...
                        <button className="bg-indigo-100 text-indigo-700 p-2 rounded-md" onClick={()=>setaddTimeModal(true)}>
                          <FiEdit />
                        </button>
                        {addTimeModal && (
                        <AddTime onClose={() => setaddTimeModal(false)} />
