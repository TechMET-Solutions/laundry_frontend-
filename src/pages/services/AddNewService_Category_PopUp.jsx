    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80">
      ...
      <div className="w-full max-w-lg rounded-2xl bg-white p-10 shadow-2xl">
        ...
        <div className="grid grid-cols-2 gap-x-10 gap-y-8">
          <InputField label="Category Name" placeholder="Category Name" required={true} /> 
          <InputField label="Color Code For Button" placeholder="Color Code For Button" required={true} />
        </div>
